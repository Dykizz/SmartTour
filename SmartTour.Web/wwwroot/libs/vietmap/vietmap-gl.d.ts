 ...
 * ll.lng; // = -123.9749
 * ```
 * @see [Get coordinates of the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/mouse-position/)
 * @see [Display a popup](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/popup/)
 * @see [Create a timeline animation](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/timeline-animation/)
 */
 ...
 * ```
 * @see [Add a custom style layer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/custom-style-layer/)
 */
 ...
 *
 * @see [Add an animated icon to the map.](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-image-animated/)
 *
 * @example
 * ```ts
 * let flashingSquare = {
 ...
 * });
 * ```
 * @see [Fit to the bounds of a LineString](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/zoomto-linestring/)
 * @see [Fit a map to a bounding box](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fitbounds/)
 */
 ...
 * (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/#sources-geojson) for detailed documentation of options.)
 *
 * @group Sources
 *
 * @example
 ...
 * });
 * ```
 * @see [Draw GeoJSON points](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/draw-geojson-points/)
 * @see [Add a GeoJSON line](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-geojson-line/)
 * @see [Create a heatmap from points](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-heatmap-layer/)
 * @see [Create and style clusters](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-and-style-clusters/)
 */
 ...
 * (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/#sources-image) for detailed documentation of options.)
 *
 * @group Sources
 *
 * @example
 ...
 * map.addSource('some id', {
 *    type: 'image',
 *    url: 'https://www.maps.vietmap.vn/images/foo.png',
 *    coordinates: [
 *        [-76.54, 39.18],
 *        [-76.52, 39.18],
 *        [-76.52, 39.17],
 ...
 *    url: 'https://www.maps.vietmap.vn/images/bar.png',
 *    coordinates: [
 *        [-76.54335737228394, 39.18579907229748],
 *        [-76.52803659439087, 39.1838364847587],
 *        [-76.5295386314392, 39.17683392507606],
...
declare class TileManager extends Evented {
	 ...
	 * See: https://maps.vietmap.vn/maplibre-gl-js/docs/examples/level-of-detail-control/
	 *
...
declare class Terrain {
	 ...
	 * @returns the elevation
	 */
	getElevationForLngLat(lnglat: LngLat): number;
	/**
...
/**
 * This type contains all data necessary to project a tile to screen in VietMap's shader system.
 ...
 * @see [Customize the map transform constrain](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/customize-the-map-transform-constrain/)
 */
...
export type QueryRenderedFeaturesOptions = {
	/**
	 * An array or set of [style layer IDs](https://maps.vietmap.vn/maplibre-style-spec/#layer-id) for the query to inspect.
	 * Only features within these layers will be returned. If this parameter is undefined, all layers will be checked.
	 */
	layers?: Array<string> | Set<string>;
	/**
	 * A [filter](https://maps.vietmap.vn/maplibre-style-spec/layers/#filter) to limit query results.
	 */
	filter?: FilterSpecification;
	/**
	...
	availableImages?: Array<string>;
	/**
	 * Whether to check if the [options.filter] conforms to the VietMap Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 */
	validate?: boolean;
};
...
export type QuerySourceFeatureOptions = {
	...
	sourceLayer?: string;
	/**
	 * A [filter](https://maps.vietmap.vn/maplibre-style-spec/layers/#filter)
	 * to limit query results.
	 */
	filter?: FilterSpecification;
	/**
	 * Whether to check if the [parameters.filter] conforms to the VietMap Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @defaultValue true
	 */
	validate?: boolean;
};
...
export type CustomRenderMethodInput = {
	...
	*/
	...
	shaderData: {
		...
		variantName: string;
		/**
		 * The prelude code to add to the vertex shader to access VietMap's `projectTile` projection function.
		 * Depends on current projection.
		 * @example
		 * ```
	...
	/**
	 * Uniforms that should be passed to the vertex shader, if VietMap's projection code is used.
 ...
 *     }
 *
 *      onAdd(map: vietmapgl.Map, gl: WebGLRenderingContext | WebGL2RenderingContext) {
 *         const vertexSource = `
...
interface Projection {
	 ...
	 * Optimized rendering paths for non-subdivided geometry might be used throughout VietMap.
	 ...
	 * Then globe projection might start reporting the mercator shader variant name to make VietMap use faster mercator shaders.
	 */
	get shaderVariantName(): string;
	/**
	 * A `#define` macro that is injected into every VietMap shader that uses this projection.
	 * @example
	...
	/**
	 * Vertex shader code that is injected into every VietMap vertex shader that uses this projection.
	 */
 ...
 * @example
 * ```ts
 * map.setStyle('https://demotiles.maps.vietmap.vn/style.json', {
 *   transformStyle: (previousStyle, nextStyle) => ({
 *       ...nextStyle,
 *       // make relative sprite path like "../sprite" absolute
 *       sprite: new URL(nextStyle.sprite, "https://demotiles.maps.vietmap.vn/styles/osm-bright-gl-style/sprites/").href,
 *       // make relative glyphs path like "../fonts/{fontstack}/{range}.pbf" absolute
 *       glyphs: new URL(nextStyle.glyphs, "https://demotiles.maps.vietmap.vn/font/").href,
 *       sources: {
 ...
 * let map = new Map({
 *   container: 'map',
 *   style: 'https://demotiles.maps.vietmap.vn/style.json',
 ...
 * });
 * ```
 * @see [Set pitch and bearing](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/set-pitch-and-bearing/)
 * @see [Jump to a series of locations](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/jump-to-a-series-of-locations/)
 * @see [Fly to a location](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fly-to-a-location/)
 * @see [Display buildings in 3D](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-buildings-in-3d/)
 */
...
declare abstract class Camera extends Evented {
	 ...
	 * @param options - Options object
	 * @param eventData - Additional properties to be added to event objects of events triggered by this method.
	 * @see [Navigate the map with game-like controls](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/navigate-the-map-with-game-like-controls/)
	 */
	 ...
	 * ```
	 * @see [Update a feature in realtime](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/update-a-feature-in-realtime/)
	 */
	 ...
	 * });
	 * ```
	 * @see [Fit a map to a bounding box](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fit-a-map-to-a-bounding-box/)
	 */
	 ...
	 * ```
	 * @see [Fly to a location](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fly-to-a-location/)
	 * @see [Slowly fly to a location](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/slowly-fly-to-a-location/)
	 * @see [Fly to a location based on scroll position](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fly-to-a-location-based-on-scroll-position/)
	 */
	 ...
	 * This method should be used for proper positioning of custom 3d objects, as explained [here](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/adding-3d-models-using-threejs-on-terrain/)
...
export type MapLayerEventType = {
	 ...
	 *
	 * @see [Measure distances](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/measure-distances/)
	 * @see [Center the map on a clicked symbol](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/center-the-map-on-a-clicked-symbol/)
	 */
	 ...
	 * @see [Create a draggable point](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-draggable-point/)
	 */
	 ...
	 *
	 * @see [Get coordinates of the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/get-coordinates-of-the-mouse-pointer/)
	 * @see [Highlight features under the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-hover-effect/)
	 * @see [Display a popup on over](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-hover/)
	 * @see [Animate symbol to follow the mouse](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/animate-symbol-to-follow-the-mouse/)
	 */
	 ...
	 *
	 * @see [Center the map on a clicked symbol](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/center-the-map-on-a-clicked-symbol/)
	 * @see [Display a popup on click](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-click/)
	 */
	 ...
	 * @see [Get coordinates of the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/get-coordinates-of-the-mouse-pointer/)
	 * @see [Highlight features under the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-hover-effect/)
	 * @see [Display a popup on hover](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-hover/)
	 */
...
export interface MapEventType {
	 ...
	 *
	 * @see [Draw GeoJSON points](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/draw-geojson-points/)
	 * @see [Add live realtime data](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-live-realtime-data/)
	 * @see [Animate a point](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/animate-a-point/)
	 */
	load: VietMapEvent;
	/**
	 ...
	 * @see [Display HTML clusters with custom properties](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-html-clusters-with-custom-properties/)
	 */
	data: MapDataEvent;
	 ...
	 * @see [Generate and add a missing icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/generate-and-add-a-missing-icon-to-the-map/)
	 */
	 ...
	 */
	boxzoomcancel: VietMapZoomEvent;
	/**
	 * Fired when a "box zoom" interaction starts. See {@link BoxZoomHandler}.
	 */
	boxzoomstart: VietMapZoomEvent;
	/**
	 * Fired when a "box zoom" interaction ends.  See {@link BoxZoomHandler}.
	 */
	boxzoomend: VietMapZoomEvent;
	/**
	 ...
	 *
	 */
	movestart: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 ...
	 * @see [Display HTML clusters with custom properties](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-html-clusters-with-custom-properties/)
	 */
	move: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 ...
	 * @see [Display HTML clusters with custom properties](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-html-clusters-with-custom-properties/)
	 */
	moveend: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 * Fired just before the map begins a transition from one zoom level to another,
	 * as the result of either user interaction or methods such as {@link Map.flyTo}.
	 */
	zoomstart: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 * Fired repeatedly during an animated transition from one zoom level to another,
	 * as the result of either user interaction or methods such as {@link Map.flyTo}.
	 */
	zoom: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 * Fired just after the map completes a transition from one zoom level to another,
	 * as the result of either user interaction or methods such as {@link Map.flyTo}.
	 */
	zoomend: VietMapEvent<MouseEvent | TouchEvent | WheelEvent | undefined>;
	/**
	 * Fired when a "drag to rotate" interaction starts. See {@link DragRotateHandler}.
	 */
	rotatestart: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired repeatedly during a "drag to rotate" interaction. See {@link DragRotateHandler}.
	 */
	rotate: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired when a "drag to rotate" interaction ends. See {@link DragRotateHandler}.
	 */
	rotateend: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired when a "drag to pan" interaction starts. See {@link DragPanHandler}.
	 */
	dragstart: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired repeatedly during a "drag to pan" interaction. See {@link DragPanHandler}.
	 */
	drag: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired when a "drag to pan" interaction ends. See {@link DragPanHandler}.
	 * @see [Create a draggable marker](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-draggable-marker/)
	 */
	dragend: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired whenever the map's pitch (tilt) begins a change as
	 * the result of either user interaction or methods such as {@link Map.flyTo} .
	 */
	pitchstart: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired repeatedly during the map's pitch (tilt) animation between
	 * one state and another as the result of either user interaction
	 * or methods such as {@link Map.flyTo}.
	 */
	pitch: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 * Fired immediately after the map's pitch (tilt) finishes changing as
	 * the result of either user interaction or methods such as {@link Map.flyTo}.
	 */
	pitchend: VietMapEvent<MouseEvent | TouchEvent | undefined>;
	/**
	 ...
	 */
	cooperativegestureprevented: VietMapEvent<WheelEvent | TouchEvent> & {
 ...
 * @group Event Related
 */
export type VietMapEvent<TOrig = unknown> = {
 ...
 * @group Event Related
 */
export type MapStyleDataEvent = VietMapEvent & {
	dataType: "style";
};
/**
 ...
 * @group Event Related
 */
export type MapSourceDataEvent = VietMapEvent & {
	dataType: "source";
	/**
	...
	/**
	 * The [style spec representation of the source](https://maps.vietmap.vn/maplibre-style-spec/#sources) if the event has a `dataType` of `source`.
	 */
	source: SourceSpecification;
	sourceId: string;
 ...
 * ```
 */
export declare class MapMouseEvent extends Event$1 implements VietMapEvent<MouseEvent> {
	/**
	 * The event type
	 */
 ...
 * @group Event Related
 */
export declare class MapTouchEvent extends Event$1 implements VietMapEvent<TouchEvent> {
	/**
	 * The event type.
	 */
...
/**
 * A `VietMapZoomEvent` is the event type for the boxzoom-related map events emitted by the {@link BoxZoomHandler}.
 *
 * @group Event Related
 */
export type VietMapZoomEvent = {
	/**
 ...
 * - `'style'`: The [style](https://maps.vietmap.vn/maplibre-style-spec/) used by the map
 *
 ...
 * @see [Generate and add a missing icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/generate-and-add-a-missing-icon-to-the-map/)
 */
export type MapStyleImageMissingEvent = VietMapEvent & {
 ...
 * });
 * ```
 * @see [Example: cooperative gestures](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/cooperative-gestures/)
 **/
...
export type MapOptions = {
	...
	interactive?: boolean;
	/**
	 * The HTML element in which VietMap GL JS will render the map, or the element's string `id`. The specified element must have no children.
	 */
	 ...
	 * !!! note
	 *     Showing the logo of VietMap is not required for using VietMap.
	 * @defaultValue compact: true, customAttribution: "VietMap ...".
	 */
	attributionControl?: false | AttributionControlOptions;
	/**
	 * If `true`, the VietMap logo will be shown.
	 */
	maplibreLogo?: boolean;
	/**
	 * A string representing the position of the VietMap wordmark on the map. Valid options are `top-left`,`top-right`, `bottom-left`, or `bottom-right`.
	...
	trackResize?: boolean;
	/**
	 * The initial geographical centerpoint of the map. If `center` is not specified in the constructor options, VietMap GL JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `[0, 0]`
	 * !!! note
	 *     VietMap GL JS uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
	 * @defaultValue [0, 0]
	 */
	center?: LngLatLike;
	/**
	...
	elevation?: number;
	/**
	 * The initial zoom level of the map. If `zoom` is not specified in the constructor options, VietMap GL JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
	 * @defaultValue 0
	 */
	zoom?: number;
	/**
	 * The initial bearing (rotation) of the map, measured in degrees counter-clockwise from north. If `bearing` is not specified in the constructor options, VietMap GL JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
	 * @defaultValue 0
	 */
	bearing?: number;
	/**
	...
	pitch?: number;
	/**
	 * The initial roll angle of the map, measured in degrees counter-clockwise about the camera boresight. If `roll` is not specified in the constructor options, VietMap GL JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
	 * @defaultValue 0
	 */
	roll?: number;
	/**
	 ...
	 * For an example, see https://maps.vietmap.vn/maplibre-gl-js/docs/examples/locale-switching/
	 ...
	 * @see [Use locally generated ideographs](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/use-locally-generated-ideographs/)
	 * @defaultValue 'sans-serif'
	 */
	localIdeographFontFamily?: string | false;
	/**
	 * The map's VietMap style. This must be a JSON object conforming to
	 * the schema described in the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/),
 ...
 * });
 * ```
 * @see [Display a map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-map/)
 */
declare class Map$1 extends Camera {
	...
	_getMapId(): number;
	/**
	 * Sets a global state property that can be retrieved with the [`global-state` expression](https://maps.vietmap.vn/maplibre-style-spec/expressions/#global-state).
	 * If the value is null, it resets the property to its default value defined in the [`state` style property](https://maps.vietmap.vn/maplibre-style-spec/root/#state).
	 *
	...
	*/
	 ...
	 * ```
	 * @see [Display map navigation controls](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-map-navigation-controls/)
	 */
	...
	*/
	 ...
	 *
	 * @param minPitch - The minimum pitch to set (0-180). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the VietMap project.
	 ...
	 *
	 * @param maxPitch - The maximum pitch to set (0-180). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the VietMap project.
	 ...
	 * ```
	 * @see [Render world copies](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/render-world-copies/)
	 */
	 ...
	 *     source: {
	 *       type: 'vector',
	 *       url: 'https://maps.vietmap.vn/maplibre-style-spec/'
	 *     },
	 ...
	 * });
	 * ```
	 * @see [Display popup on click](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-click/)
	 * @see [Center the map on a clicked symbol](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/center-the-map-on-a-clicked-symbol/)
	 * @see [Create a hover effect](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-hover-effect/)
	 * @see [Create a draggable marker](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-draggable-point/)
	 */
	 ...
	 * ```
	 * @see [Get features under the mouse pointer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/get-features-under-the-mouse-pointer/)
	 */
	 ...
	 * [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/), or a URL to such JSON.
	 * @param options - The options object.
	 *
	 * @example
	 * ```ts
	 ...
	 * VietMap Style Specification's [source definition](https://maps.vietmap.vn/maplibre-style-spec/sources) or
	 * {@link CanvasSourceSpecification}.
	 * @example
	 * ```ts
	 * map.addSource('my-data', {
	 *   type: 'vector',
	 *   url: 'https://demotiles.maps.vietmap.vn/tiles/tiles.json'
	 * });
	 * ```
	 * @example
	 * ```ts
	 ...
	 * });
	 * ```
	 * @see GeoJSON source: [Add live realtime data](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-live-realtime-data/)
	 */
	 ...
	 * [Sources](https://maps.vietmap.vn/maplibre-style-spec/sources/) page.
	 * @example
	 * ```ts
	 ...
	 * ```
	 * @see [Modify Level of Detail behavior](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/level-of-detail-control/)
	 ...
	 * [`icon-image`](https://maps.vietmap.vn/maplibre-style-spec/layers/#layout-symbol-icon-image),
	 * [`background-pattern`](https://maps.vietmap.vn/maplibre-style-spec/layers/#paint-background-background-pattern),
	 * [`fill-pattern`](https://maps.vietmap.vn/maplibre-style-spec/layers/#paint-fill-fill-pattern),
	 * or [`line-pattern`](https://maps.vietmap.vn/maplibre-style-spec/layers/#paint-line-line-pattern).
	 *
	 ...
	 * });
	 * ```
	 * @see Use `HTMLImageElement`: [Add an icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-an-icon-to-the-map/)
	 * @see Use `ImageData`: [Add a generated icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-generated-icon-to-the-map/)
	 */
	 ...
	 * ```
	 * @see [Add an icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-an-icon-to-the-map/)
	 */
	...
	listImages(): Array<string>;
	/**
	 * Adds a [VietMap style layer](https://maps.vietmap.vn/maplibre-style-spec/layers)
	 * to the map's style.
	 *
	 * A layer defines how data from a specified source will be styled. Read more about layer types
	 * and available paint and layout properties in the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/layers).
	 *
	 * @param layer - The layer to add,
	 * conforming to either the VietMap Style Specification's [layer definition](https://maps.vietmap.vn/maplibre-style-spec/layers) or,
	 ...
	 * The VietMap Style Specification's layer definition is appropriate for most layers.
	 *
	 ...
	 * ```
	 * @see [Create and style clusters](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-and-style-clusters/)
	 * @see [Add a vector tile source](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-vector-tile-source/)
	 * @see [Add a WMS source](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-wms-source/)
	 */
	 ...
	 * ```
	 * @see [Filter symbols by toggling a list](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/filter-symbols-by-toggling-a-list/)
	 * @see [Filter symbols by text input](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/filter-symbols-by-text-input/)
	 */
	getLayer(id: string): StyleLayer | undefined;
	/**
	 * Return the ids of all layers currently in the style, including custom layers, in order.
	 ...
	 * [minimum zoom level](https://maps.vietmap.vn/maplibre-style-spec/layers/#minzoom)
	 * and [maximum zoom level](https://maps.vietmap.vn/maplibre-style-spec/layers/#maxzoom))
	 ...
	 * @param filter - The filter, conforming to the VietMap Style Specification's
	 * [filter definition](https://maps.vietmap.vn/maplibre-style-spec/layers/#filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
	 * @param options - Options object.
	 *
	 * @example
	 ...
	 * ```
	 * @see [Create a timeline animation](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-time-slider/)
	 */
	 ...
	 * Must be of a type appropriate for the property, as defined in the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/).
	 ...
	 * ```
	 * @see [Change a layer's color with buttons](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/change-a-layers-color-with-buttons/)
	 * @see [Create a draggable point](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-draggable-point/)
	 */
	 ...
	 * @param value - The value of the layout property. Must be of a type appropriate for the property, as defined in the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/).
	 * @param options - The options object.
	 * @example
	 * ```ts
	 ...
	 *
	 * @param glyphsUrl - Glyph URL to set. Must conform to the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/glyphs/).
	 * @param options - Options object.
	 * @example
	 * ```ts
	 * map.setGlyphs('https://demotiles.maps.vietmap.vn/font/{fontstack}/{range}.pbf');
	 * ```
	 */
	 ...
	 *
	 * @param light - Light properties to set. Must conform to the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/light).
	 * @param options - Options object.
	 *
	 * @example
	 * ```ts
	 ...
	 *
	 * @param sky - Sky properties to set. Must conform to the [VietMap Style Specification](https://maps.vietmap.vn/maplibre-style-spec/sky/).
	 * @param options - Options object.
	 *
	 * @example
	 * ```ts
	 ...
	 * - For vector or GeoJSON sources, using the [`promoteId`](https://maps.vietmap.vn/maplibre-style-spec/sources/#promoteid) option at the time the source is defined.
	 * - For GeoJSON sources, using the [`generateId`](https://maps.vietmap.vn/maplibre-style-spec/sources/#generateid) option to auto-assign an `id` based on the feature's index in the source data. If you change feature data using `map.getSource('some id').setData(..)`, you may need to re-apply state taking into account updated `id` values.
	 *
	 * !!! note
	 *     You can use the [`feature-state` expression](https://maps.vietmap.vn/maplibre-style-spec/expressions/#feature-state) to access the values in a feature's state object for the purposes of styling.
	 *
	 ...
	 *
	 * !!! note
	 *     To access the values in a feature's state object for the purposes of styling the feature, use the [`feature-state` expression](https://maps.vietmap.vn/maplibre-style-spec/expressions/#feature-state).
	 *
	 * @param feature - Feature identifier. Feature objects returned from
	 * {@link Map.queryRenderedFeatures} or event handlers can be used as feature identifiers.
	 ...
	 * map.triggerRepaint();
	 * ```
	 * @see [Add a 3D model](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-3d-model-using-threejs/)
	 * @see [Add an animated icon to the map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-an-animated-icon-to-the-map/)
	 */
	triggerRepaint(): void;
 ...
 *   .addTo(map);
 * ```
 * @see [Display a popup](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup/)
 * @see [Display a popup on hover](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-hover/)
 * @see [Display a popup on click](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-click/)
 * @see [Attach a popup to a marker instance](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/attach-a-popup-to-a-marker-instance/)
 *
 * ## Events
 *
...
export declare class Popup extends Evented {
	 ...
	 *
	 * @param map - The VietMap GL JS map to add the popup to.
	 * @example
	 * ```ts
	 * new Popup()
	 *   .setLngLat([0, 0])
	 ...
	 * @see [Display a popup on hover](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-hover/)
	 * @see [Display a popup on click](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-popup-on-click/)
	 * @see [Show polygon information on click](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/show-polygon-information-on-click/)
	 */
	addTo(map: Map$1): this;
	/**
 ...
 *   .addTo(map);
 * ```
 * @see [Add custom icons with Markers](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-custom-icons-with-markers/)
 * @see [Create a draggable Marker](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/create-a-draggable-marker/)
 *
 * ## Events
 *
...
export declare class Marker extends Evented {
	 ...
	 * @param map - The VietMap GL JS map to add the marker to.
	 * @example
	 * ```ts
	 * let marker = new Marker()
	 *   .setLngLat([30.5, 50.5])
 ...
 * }));
 * ```
 * @see [Locate the user](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/locate-the-user/)
 *
 * ## Events
 *
 ...
 * ```
 * @see [View a fullscreen map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/fullscreen/)
 *
 * ## Events
 *
 ...
 * ```
 *
 * @see [Display a globe with a fill extrusion layer](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-globe-with-a-fill-extrusion-layer/)
 */
 ...
 * const start = vietmapgl.now();
 * // ... later ...
 * const elapsed = vietmapgl.now() - start;
 *
 * // During frozen time
 * vietmapgl.setNow(16.67);
 * console.log(vietmapgl.now()); // 16.67
 * vietmapgl.restoreNow();
 * console.log(vietmapgl.now()); // real time
 * ```
 */
...
/**
 * A source containing raster tiles (See the [raster source documentation](https://maps.vietmap.vn/maplibre-style-spec/sources/#raster) for detailed documentation of options.)
 *
 * @group Sources
 *
 ...
 * });
 * ```
 * @see [Add a raster tile source](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/map-tiles/)
 * @see [Add a WMS source](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/add-a-wms-source/)
 * @see [Display a satellite map](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/display-a-satellite-map/)
 */
export declare class RasterTileSource extends Evented implements Source {
	 ...
	 *
	 * @param tiles - An array of one or more tile source URLs, as in the raster tiles spec (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/)
	 */
...
/**
 * A source containing raster DEM tiles (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/) for detailed documentation of options.)
 ...
 *      type: 'raster-dem',
 *      url: 'https://demotiles.maps.vietmap.vn/terrain-tiles/tiles.json',
 *      tileSize: 256
 * });
 * ```
 * @see [3D Terrain](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/3d-terrain/)
 */
...
/**
 * A source containing vector tiles in [Maplibre Vector Tile format](https://maps.vietmap.vn/maplibre-tile-spec/) or [Mapbox Vector Tile format](https://docs.mapbox.com/vector-tiles/reference/).
 * (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/) for detailed documentation of options.)
 *
 * @group Sources
 *
 * @example
 ...
 * @example
 * ```ts
 * map.getSource('some id').setUrl("https://demotiles.maps.vietmap.vn/tiles/tiles.json");
 * ```
 *
 * @example
 * ```ts
 ...
 * (See the [Style Specification](https://maps.vietmap.vn/maplibre-style-spec/#sources-video) for detailed documentation of options.)
 *
 * @group Sources
 *
 * @example
 ...
 * map.removeSource('some id');  // remove
 * ```
 * @see [Add a video](https://maps.vietmap.vn/maplibre-gl-js/docs/examples/video-on-a-map/)
 *
 ...
 * @param lazy - If set to `true`, vietmap will defer loading the plugin until rtl text is encountered,
 * rtl text will then be rendered only after the plugin finishes loading.
 * @example
 * ```ts
 * setRTLTextPlugin('https://unpkg.com/@mapbox/mapbox-gl-rtl-text@0.3.0/dist/mapbox-gl-rtl-text.js', false);
 * ```
 * @see [Add support for right-to-left scripts](https://maps.vietmap.vn/docs/examples/mapbox-gl-rtl-text/)
 */
